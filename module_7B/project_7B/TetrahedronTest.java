...
*/   
   @Test public  void testEquals() {
      ...
      Tetrahedron th3 = th;
      Tetrahedron th4 = new Tetrahedron("Small Example", 5.0);
      
      Assert.assertTrue(th.equals(th));
      Assert.assertFalse(th.equals(th2));
      Assert.assertTrue(th.equals(th3));
      Assert.assertFalse(th.equals(input));
      Assert.assertFalse(th.equals(th4));
...
/**
* This test method tests the compareTo() method.
*/
   @Test public void testCompareTo() {
      Tetrahedron th = new Tetrahedron(null, -1.0);
      Tetrahedron th2 = new Tetrahedron("Medium Example", 12.8);
      Tetrahedron th3 = new Tetrahedron("Equal Example", 0.5);
      
      Assert.assertEquals(0, th.compareTo(th));
      Assert.assertEquals(1, th2.compareTo(th));
      Assert.assertEquals(-1, th.compareTo(th2));
   }
