...
/**
* A program to take a message as user input and perform actions on it
* using methods from Java's String class.
* 
* Module 3: Activity 3 (MessageConverter.java)
* @author Jared Thacker
* @version February 1,2021
*/
public class MessageConverter {
/**
* A program to perform certain actions on user input.
*
